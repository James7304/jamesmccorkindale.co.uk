...
<head>
    ...
    <title>James McCorkindale</title>
    
    <link rel="stylesheet" href="styles/media.css">
    <link href="./styles/flatly_bootstrap.css" rel="stylesheet">
...
<section class="py-5 container" width="100%">
    ...
    <div class="row">
        ...
        <div id="main-info" class="main-info">
            ...
            <h1>James McCorkindale</h1>
            <p><b>Website Developer ∙ Maths Tutoring</b></p>

            <p> 
                <b>Phone: </b>07482 561740 <br>
                <b>Email: </b>jamesmccorkindale0@gmail.com
            </p>
        ...
        <div id="profile" class="profile d-flex justify-content-center">
...
<section class="py-5 container" width="100%">
    ...
    <div class="row align-items-center" width="50%">
            ...
            <table class="table table-hover table-striped">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col">View in Browser</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <tr class="table-primary">
                        ...
                        <td>CV</td>
                        <td><a href="docs/cv.pdf" download>
                        ...
                        <td>
                        <a href="docs/cv.pdf" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16">
                    ...
                    <tr class="table-primary">
                        ...
                        <td>UCAS Personal Statement</td>
                        <td><a href="docs/ucas.pdf" download>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                            <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
                            <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
                        </svg>
                        ...
                        <td>
                        <a href="docs/ucas.pdf" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5z"/>
                        </svg>
                        </td>
                    </tr>
                    ...
                    <tr class="table-primary">
                        ...
                        <td>UCAS Personal Statement</td>
                        <td><a href="docs/ucas.docx" download>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                            <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
                            <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
                        </svg>
...
<script src="scripts/slide_in_animation.js">
</script>
    ...
    if(!empty($_GET)){
        echo "
            ...
            <script>
                ...
                document.getElementById('contactform-section').scrollIntoView();
